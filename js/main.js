(function () {
  ...
  var countDownDate = new Date("Dec 16, 2021 09:00:00").getTime();
  ...
  var x = setInterval(function () {
    ...
    // document.getElementById("demo").innerHTML = hari + "hari " + jam + "jam "
    // + menit + "menit " + detik + "detik ";

    // Display the result in an element with id="demo"
    document.getElementById("hari").innerHTML = hari + " <small>hari</small>";
    document.getElementById("jam").innerHTML = jam + " <small>jam</small> ";
    document.getElementById("menit").innerHTML =
      menit + " <small>menit</small> ";
    document.getElementById("detik").innerHTML =
      detik + " <small>detik</small> ";
